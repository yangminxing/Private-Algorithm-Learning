package yangminxing.algorithm.DP;

/**
 * Provide a program that solves N-Queen problem.
 *
 * @author ymx 2019-05-15
 */
public class NQueen {
     ...
     * Set the Queen count.
     */
    public static final int SQUARE_LENGTH = 8;
     ...
     */
    public static int rowCursor = 0;

    public static void main(String[] args) {
        NQueen solution = new NQueen();
        solution.findRowQueen(new int[SQUARE_LENGTH][SQUARE_LENGTH], 0);
     ...
     */
    public void printResult(int[][] oriArrays) {
        for (int xa = 0; xa < oriArrays.length; xa++) {
            for (int j = 0; j < oriArrays[xa].length; j++) {
                System.out.print(oriArrays[xa][j] + ",");
            }
            System.out.println();
        }
        System.out.println("---------------");
